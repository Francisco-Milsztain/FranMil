      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            Text("Title: ${juego.title}", style: TextStyle(fontSize: 20)),
            SizedBox(height: 10),
            Text("Category: ${juego.category}", style: TextStyle(fontSize: 20)),
            SizedBox(height: 10),
            Text("Creator: ${juego.creator}", style: TextStyle(fontSize: 20)),
            SizedBox(height: 10),
            Text("Year: ${juego.year}", style: TextStyle(fontSize: 20)),

            SizedBox(height: 20),

            ElevatedButton(
              onPressed: () async {
                await ref.read(listaJuegosProvider.notifier).deletegame(juego);
